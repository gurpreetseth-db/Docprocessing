...
SCHEMA = "docprocess_bronze"
VOLUME = f"/Volumes/{CATALOG}/{SCHEMA}/InputPDFs/"
...
# DBTITLE 1,Generate PDF Function
...
for i in range(20):
    ...
    with open(f"{VOLUME}{filename}", "wb") as f:
        f.write(pdf_bytes)
